...
namespace Lab3.Controllers
{
    public class BooksController : Controller
    {
        ...
        public BooksController(Lab3Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index(string bookGenre, string searchString)
        {
            ...
            {
                return Problem("Entity set 'Lab3Context.Book' is null.");
            }

            IQueryable<string> genreQuery = from bookInstance in _context.Book
                                            orderby bookInstance.Genre
                                            select bookInstance.Genre;
